...
A free, fan-made World Cup draft game with a **live world leaderboard**. Spin the wheel, draft legends from **64 iconic World Cup squads (1950–2022, 742 players)**, pick your formation and captain, then live out the whole tournament minute by minute — tactics at half-time, extra time, penalty shootouts.
...
Squad data lives in [src/squads-new.mjs](src/squads-new.mjs) (v2 additions) merged with the v1 squads by `scripts/extract.mjs`. The v1 game is preserved at [v1/index.html](v1/index.html).
